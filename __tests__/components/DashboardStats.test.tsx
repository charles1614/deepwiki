...
describe('DashboardStats', () => {
  ...
  it('displays statistics with trend indicators', async () => {
    ...
    expect(await screen.findByText('15')).toBeInTheDocument() // totalWikis
    expect(await screen.findByText('8')).toBeInTheDocument() // recentUploads
    expect(await screen.findByText('42')).toBeInTheDocument() // totalDocuments
